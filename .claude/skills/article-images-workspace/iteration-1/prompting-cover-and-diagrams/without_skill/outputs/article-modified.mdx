...
{/* DIAGRAM INSERT: anatomy of an effective prompt — four-quadrant card layout */}
<img
  src="/images/articles/prompting-diagram-1-anatomy.svg"
  alt="I quattro elementi fondamentali di un prompt efficace: Contesto, Obiettivo, Vincoli, Criterio di successo"
  width={800}
  height={420}
...
{/* DIAGRAM INSERT: multi-agent workflow — vertical timeline with steps, artifacts, and human checkpoint */}
<img
  src="/images/articles/prompting-diagram-2-workflow.svg"
  alt="Workflow multi-agente: Research Agent, Planning Agent, Human Checkpoint, Implementation Agent, Review Agent — con artefatti prodotti da ogni step"
  width={800}
  height={500}
  className="my-8 rounded-lg w-full"
/>
...
{/* DIAGRAM INSERT: feedback loop — circular flow: Modifica → Test/Type Check → Pass (next file) / Fail → Correggi → Modifica */}
<img
  src="/images/articles/prompting-diagram-3-feedback-loop.svg"
  alt="Il ciclo di feedback deterministico: Modifica → Test/Type Check → se Pass passa al file successivo, se Fail correggi e riprova"
  width={800}
  height={420}
  className="my-8 rounded-lg w-full"
/>
