      ...
      >
        <div className="mx-auto w-full max-w-5xl">
          <svg viewBox="0 0 760 430" className="w-full">
            ...
            />
            <text x="60" y="133" fill="var(--pres-text)" fontSize="20" fontWeight="700">
              index.ts
            </text>
            ...
            />
            <text x="485" y="104" fill="var(--pres-success)" fontSize="20" fontWeight="700">
              _internal/
            </text>
            ...
            {[
              ...
              >
                <rect
                  ...
                  stroke="var(--pres-border)"
                />
                <text x="492" y={145 + i * 44} fill="var(--pres-text-sub)" fontSize="13">
                  {item}
                </text>
              </motion.g>
            ))}
            ...
            >
              <tspan x="390" dy="0">unico punto</tspan>
