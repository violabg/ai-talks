...
3. isola una dipendenza o estrai una funzione che crei un confine più chiaro
...
6. riesegui test locali, integrazione e verifiche più ampie
...
stai quasi chiedendo una riscrittura cosmetica. Il risultato tipico è una combinazione pericolosa di:
...
Questo riduce molto il rischio di diff opachi. E rende la review umana molto più economica.
